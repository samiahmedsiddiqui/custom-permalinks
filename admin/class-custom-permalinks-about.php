...
class CustomPermalinksAbout {
  ...
  private function morePlugins() {
    $pluginUrl = plugins_url( '/admin', CUSTOM_PERMALINKS_FILE );
    $imgSrc    = $pluginUrl . '/images';
    wp_enqueue_style( 'style', $pluginUrl . '/css/about-plugins.min.css' );
    $pluginName = __( 'Custom Permalinks', 'custom-permalinks' );
    $buttonText = __( 'Check it out', 'custom-permalinks' );
    ...
    <div class="wrap">
      <div class="float">
        <h1><?php echo $pluginName . ' v' . CUSTOM_PERMALINKS_PLUGIN_VERSION; ?></h1>
        <div class="tagline">
      ...
      <div class="float">
        <object type="image/svg+xml" data="<?php echo $imgSrc;?>/custom-permalinks.svg" width="128" height="128"></object>
      </div>
      ...
      <div class="product">
        ...
        <div class="box recommended">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/prevent-xss-vulnerability.png" style="transform:scale(1.5)" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/prevent-xss-vulnerability/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>

        <div class="box">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/permalinks-customizer.svg" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/permalinks-customizer/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>

        <div class="box recommended">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/http-auth.svg" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/http-auth/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>

        <div class="box">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/schema-for-article.svg" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/schema-for-article/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>

        <div class="box">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/make-paths-relative.svg" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/make-paths-relative/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>

        <div class="box">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/json-structuring-markup.svg" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/json-structuring-markup/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>

        <div class="box">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/remove-links-and-scripts.svg" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/remove-links-and-scripts/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>

        <div class="box">
          <div class="img">
            <img src= "<?php echo $imgSrc; ?>/media-post-permalink.png" style="transform:scale(1.5)" />
          </div>
          ...
          <a href="https://wordpress.org/plugins/media-post-permalink/" class="checkout-button" target="_blank"><?php echo $buttonText; ?></a>
        </div>
      </div>
    </div>
    <?php
